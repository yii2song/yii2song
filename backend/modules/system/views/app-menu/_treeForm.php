...
<?php if ($iconsList == 'text' || $iconsList == 'none'): ?>
    ...
    <?php if ($iconsList === 'text'): ?>
        <div class="row">
            <div class="col-sm-12">
                <div class="hide"><?= $form->field($node, $iconTypeAttribute)->hiddenInput() ?></div>
                <?= $form->field($node, $iconAttribute)->widget('\common\components\iconinput\IconInput',[
                    'data' => \yii\helpers\ArrayHelper::map(\common\models\system\App::find()
